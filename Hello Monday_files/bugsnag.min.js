! function(e) {
  ...
  N.schema = {
    ...
    logger: {
      ...
      validate: function(e) {
        return !e || e && k(["debug", "info", "warn", "error"], function(t, n) {
  ...
  var jt = function(e) {
        ...
        window.onerror = function(n, r, i, o, a) {
          if (0 === i && /Script error\.?/.test(n)) e._logger.warn("Ignoring cross-domain or eval script error. See docs: https://tinyurl.com/y94fq5zm");
            ...
            var s = {
              ...
              u = void 0;
            if (a) a.name && a.message ? u = new e.BugsnagReport(a.name, a.message, Rt(e.BugsnagReport.getStacktrace(a), r, i, o), s) : (u = new e.BugsnagReport("window.onerror", String(a), Rt(e.BugsnagReport.getStacktrace(a, 1), r, i, o), s)).updateMetaData("window onerror", {
              error: a
            });
            else if ("object" != typeof n || null === n || r || i || o || a)(u = new e.BugsnagReport("window.onerror", String(n), Rt(e.BugsnagReport.getStacktrace(a, 1), r, i, o), s)).updateMetaData("window onerror", {
              event: n
            });
            else {
    ...
    _t = function(e) {
      ...
      if (t.length > 1e6 && (delete e.events[0].metaData, e.events[0].metaData = {
        ...
        }, (t = kt(e)).length > 1e6)) throw new Error("payload exceeded 1MB limit");
      return t
    },
    Ct = {},
    qt = w.isoDate;
